...
export default function CustomDataTable(){
    ...
    return(
        <div className="">
            <p className='mb-4 font-semibold text-gray-800 dark:text-gray-300'>Recent Orders</p>
            {/* Table */}
            <div className="">
                <div className="relative overflow-x-auto shadow-md sm:rounded-lg">
                    ...
                    <nav className="flex items-center flex-column flex-wrap md:flex-row justify-between pt-4"
                        ...
                        <span
                            ...
                            className="font-semibold text-gray-900 dark:text-white">{itemStartIndex}-{itemEndIndex}</span> of <span
                            className="font-semibold text-gray-900 dark:text-white">{data.length}</span></span>
                                    ...
                                    return (
                                        <li key={index}>
                                            <button
                                                ...
                                                className={currentPage === index+1?"flex items-center justify-center px-3 h-8 leading-tight text-gray-50 bg-blue-600 border border-blue-800 hover:bg-blue-100 hover:text-white dark:bg-blue-800 dark:border-blue-700 dark:text-gray-50 dark:hover:bg-blue-700 dark:hover:text-white":"flex items-center justify-center px-3 h-8 leading-tight text-gray-500 bg-white border border-gray-300 hover:bg-gray-100 hover:text-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white"}>
                                                {index+1}
                                            </button>
                                        </li>
                                    )
